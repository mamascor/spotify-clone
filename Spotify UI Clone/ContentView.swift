        ...
        ZStack{
            ...
            VStack {
                ...
                VStack{
                    ...
                    VStack(spacing: 24){
                       Track(name: "Hollywood's Bleeding", artists: "Post Malone", explicit: false, playing: false)
                        
                        Track(name: "Saint-Tropez", artists: "Post Malone", explicit: true, playing: true)
                        
                        Track(name: "Enemies (feat. DaBaby)", artists: "Post Malone, DaBaby", explicit: true, playing: false)
                        
                        Track(name: "Allergic", artists: "Post Malone", explicit: true, playing: false)
                    }.padding(.top)
                }
                Spacer()
            }
